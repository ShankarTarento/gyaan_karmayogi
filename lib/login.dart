              ...
              child: Focus(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: AppLocalizations.of(context).mStaticEmail,
    ...
    return Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context).mInputPassword,
              style: GoogleFonts.lato(
                color: AppColors.greys87,
                fontSize: 14.0,
                fontWeight: FontWeight.w700,
              ...
              child: Focus(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    contentPadding: EdgeInsets.fromLTRB(20.0, 0.0, 20.0, 0.0),
                    hintText: AppLocalizations.of(context).mInputPassword,
                    hintStyle: GoogleFonts.lato(
                        color: AppColors.grey40,
                        fontSize: 14.0,
                        fontWeight: FontWeight.w400),
  ...
  Widget _forgotPassword() {
    return Center(
      child: Container(
        ...
        child: Text(
          AppLocalizations.of(context).mStaticForgotPassword,
          style: GoogleFonts.lato(
              color: AppColors.primaryThree,
              fontSize: 14.0,
              fontWeight: FontWeight.w700,
