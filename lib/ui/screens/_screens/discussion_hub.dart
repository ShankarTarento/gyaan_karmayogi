...
class DiscussionHub extends StatefulWidget {
  ...
  final String title;
  const DiscussionHub({Key key, this.title}) : super(key: key);
...
class _DiscussionHubState extends State<DiscussionHub>
  ...
  void didChangeDependencies() {
    ...
    if (widget.title != null) {
      for (int index = 0;
          index < DiscussionTab.items(context: context).length;
          index++) {
        if (DiscussionTab.items(context: context)[index].title ==
            widget.title) {
          _controller = TabController(
              length: DiscussionTab.items(context: context).length,
              vsync: this,
              initialIndex: index);
          break;
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        title: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                AppLocalizations.of(context).mCommonDiscuss,
                    ...
                    SliverPersistentHeader(
                      delegate: SilverAppBarDelegate(
                        TabBar(
                          ...
                          tabs: [
                            for (var tabItem
                                in DiscussionTab.items(context: context))
                              Container(
                                // width: 125.0,
                                padding:
        ...
        floatingActionButton: Padding(
          ...
          child: OpenContainer(
              closedElevation: 10,
              openColor: AppColors.darkBlue,
              transitionDuration: Duration(milliseconds: 750),
              openBuilder: (context, _) => NewDiscussionPage(),
              closedShape: CircleBorder(),
              closedColor: AppColors.darkBlue,
