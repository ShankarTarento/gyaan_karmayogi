...
class _CompetencyHubState extends State<CompetencyHub>
  ...
  void didChangeDependencies() {
    _controller = TabController(
        length: CompetencyTab.items(context: context).length,
        vsync: this,
        initialIndex: 0);
                    ...
                    SliverPersistentHeader(
                      delegate: SilverAppBarDelegate(
                        TabBar(
                          ...
                          tabs: [
                            for (var tabItem
                                in CompetencyTab.items(context: context))
                              Container(
                                // width: 125.0,
                                padding:
                          ...
                          return TabBarView(
                            ...
                            children: [
                              YourCompetenciesPage(
                                ...
                                currentTab: widget.isAddedCompetencies ? 2 : 0,
                              ),
                              AllCompetenciesPage(),
