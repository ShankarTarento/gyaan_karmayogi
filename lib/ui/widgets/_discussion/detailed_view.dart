...
class DetailedView extends StatefulWidget {
  ...
  DetailedView({this.tid, this.backToTitle = '', this.updateReportStatus});
...
class _DetailedViewState extends State<DetailedView>
      ...
      if (_currentPage == 1 ||
        ...
        if (_currentPage == 1) {
          ...
          _flaggedDiscussions.forEach((flagged) {
            _comments.removeWhere((data) =>
                data['pid'] == int.parse(flagged['contextTypeId']) ||
  ...
  _updateReportStatus() async {
    ...
    await _discussionByTid(context, widget.tid);
    await widget.updateReportStatus();
    setState(() {});
  }
  ...
  void dispose() async {
    ...
    _upvotecommentAnimationController.dispose();
    _upvoteDiscussionAnimationController.dispose();
    _downvotecommentAnimationController.dispose();
    _downvoteDiscussionAnimationController.dispose();
    super.dispose();
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                                ...
                                                snapshot.data.posts[0] != null
                                                    ? (snapshot.data.posts[0]
                                                        ...
                                                        : snapshot.data.posts[0]
                                                                ...
                                                                ['username'] +
                                                            ' . '
                                                    : AppLocalizations.of(context).mStaticName + ' . ',
                                                style: GoogleFonts.lato(
                                ...
                                Text(
                                  snapshot.data != null
                                      ? snapshot.data.title
                                      : AppLocalizations.of(context).mDiscussionQuestion,
                                  style: GoogleFonts.lato(
                                    color: AppColors.greys87,
                                    fontSize: 16.0,
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            snapshot.data.category != null
                                                ...
                                                : AppLocalizations.of(context).mStaticCategory,
                                            style: GoogleFonts.lato(
                                                      ...
                                                      child: Text(
                                                        snapshot.data != null
                                                            ? (_discussionDetails
                                                                        .viewCount)
                                                                    .toString() +
                                                                AppLocalizations.of(context).mStaticView
                                                            : '0 (${AppLocalizations.of(context).mStaticView})',
                                                        style: GoogleFonts.lato(
                                                            color: AppColors
                                                                .greys60,
                                                            fontSize: 14.0,
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Center(
                                                                  child: Text(
                                                                    _comments[i] !=
                                                                            null
                                                                        ? ((_comments[i]['user']['fullname'] != null &&
                                                                                _comments[i]['user']['fullname'] != '')
                                                                            ? Helper.getInitialsNew(_comments[i]['user']['fullname'])
                                                                            : Helper.getInitialsNew(_comments[i]['user']['username']))
                                                                        : 'UN',
                                                                    style:
                                                                        GoogleFonts
                                                                            .lato(
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Text(
                                                                      (dateNow.from(DateTime.fromMillisecondsSinceEpoch(_comments[i]
                                                                              [
                                                                              'timestamp'])))
                                                                          .toString(),
                                                                      style: GoogleFonts
                                                              ...
                                                              ? IconButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    showModalBottomSheet(
                                                                        ...
                                                                        builder: (ctx) =>
                                                                            ReportItem(
                                                                              contextType: EnglishLang.discussionTopicFlag,
                                                                              contextTypeId: _comments[i]['pid'].toString(),
                                                                              updateReportStatus: _updateReportStatus,
                                                                              userId: _comments[i]['user']['uid'].toString(),
                                                                            ));
                                                                    setState(
                                                                        () {
                                                                      _activeIndex =
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        children: [
                                                                          InkWell(
                                                                            ...
                                                                            child:
                                                                                ScaleTransition(
                                                                              scale: _upvoteDiscussionAnimationController,
                                                                              child: SvgPicture.asset(
                                                                                'assets/img/up_vote.svg',
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              _comments[i] != null ? (_comments[i]['upvotes']).toString() : '0',
                                                                              style: GoogleFonts.lato(color: _comments[i]['upvoted'] ? Colors.green : AppColors.greys87, fontSize: 14.0, fontWeight: FontWeight.w700),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () async => _comments[i]['downvoted'] ? _deleteDownVote(context, _comments[i]['pid'], _comments[i]['tid'], i, _comments[i]['display_delete_tools']) : _postDownVote(context, _comments[i]['pid'], _comments[i]['tid'], i, _comments[i]['display_delete_tools']),
                                                                              child: ScaleTransition(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            FadeRouteBottomUp(
                                                                              ...
                                                                              tid: _comments[i]['tid'],
                                                                              pid: _comments[i]['pid'],
                                                                              userName: _comments[i]['user']['username'],
                                                                              title: _comments[i]['content'],
                                                                            )),
                                                                          )
                                                                        },
                                                                        child:
  ...
  Widget _getCommentReplies(BuildContext context, posts, j) {
    _flaggedDiscussions.forEach(
      (flagged) {
        posts.removeWhere((data) =>
            data['toPid'] == int.parse(flagged['contextTypeId']) ||
            data['user']['uid'] == int.parse(flagged['contextTypeId']));
      },
    );

    var repliesCount =
        (posts.where((data) => (data['toPid'] == _comments[j]['pid']))).length;
            ...
            child: ExpansionTile(
              ...
              title: Text(
                posts[j]['replies']['count'].toString() +
                    (posts[j]['replies']['count'] == 1 ? AppLocalizations.of(context).mDiscussReply : AppLocalizations.of(context).mDiscussReplies),
                style: GoogleFonts.lato(
                  color: AppColors.greys87,
                  fontSize: 14.0,
                  letterSpacing: 0.25,
                                                    ...
                                                    Text(
                                                      posts[i] != null
                                                          ? posts[i]['user'][
                                                              ...
                                                              : posts[i]['user']
                                                                  ['username']
                                                          : AppLocalizations.of(context).mStaticUsername,
                                                      style: GoogleFonts.lato(
                                                          color:
                                                              AppColors.greys60,
                                                          fontSize: 14.0,
