    ...
    if (widget.visualizationData['chartType'] == 'bar' ||
      ...
      for (int i = 0; i < chartRawData[0]['plots'].length; i++) {
        ...
        lineChartData.add(LineChartModel(
          ...
          labelAxis: chartRawData[0]['plots'][i]['name'].toString(),
          dataAxis: chartRawData[0]['plots'][i]['value'].toDouble(),
                                  ...
                                  child: Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return MetricChart(
                                            isMultiple:
                                                widget.visualizationData['innerWidget'].length > 1
                                                    ? true
                                                    : false,
                                            title:
                                                widget.visualizationData['innerWidget']
                                                    [index]['headerName'],
                                            value: widget
                                                        .visualizationData['innerWidget']
                                                            [index]
                                                ...
                                                ? int.parse(widget
                                                    ...
                                                    .toInt()
                                                    .toString())
                                                : int.parse(widget.visualizationData['innerWidget'][index]['headerValue'].toString()));
