...
import 'package:karmayogi_mobile/charts/expanded_items.dart';
import 'package:karmayogi_mobile/services/index.dart';
import 'package:karmayogi_mobile/ui/widgets/_assistant/image_view.dart';
import 'package:karmayogi_mobile/ui/widgets/_assistant/typing_indicator.dart';
import 'package:karmayogi_mobile/ui/widgets/_assistant/vega_files_view.dart';
import 'package:karmayogi_mobile/ui/widgets/_assistant/vega_youtube_player.dart';
...
class VoiceSearchResults extends StatefulWidget {
  ...
  VoiceSearchResults(this.searchText,
      {this.isPublic = false, this.selectedLanguage});
  @override
...
class _VoiceSearchResultsState extends State<VoiceSearchResults> {
  ...
  bool isCourseCompetency = false;
  Map _courseCompetency;
  bool isCompetencyCourses = false;
  Map _competencyCourses;
  dynamic _images;
  ...
  _translateToHindi(String text) async {
    if (widget.selectedLanguage == EnglishLang.hindi) {
      // final translator = GoogleTranslator();
      Translation translation = await _translator.translate(text, to: 'hi');
  ...
  void _processResponse(data) {
    ...
    switch (data[0]['type']) {
      ...
      case IntentType.coursesCompetency:
        {
          if (mounted) {
            setState(() {
              isCourseCompetency = true;
              _courseCompetency = data[0]['quick_replies'][0]['data'];
              // print(data[0]['quick_replies'][0]['data']);
            });
          }
        }
        break;
      case IntentType.competencyCourses:
        {
          if (mounted) {
            setState(() {
              isCompetencyCourses = true;
              _competencyCourses = data[0]['quick_replies'][0]['data'];
              // print(data[0]['quick_replies'][0]['data']);
            });
          }
        }
      ...
      case IntentType.images:
        {
          if (mounted) {
            setState(() {
              _isImages = true;
              _images = data[0]['quick_replies'][0]['data'];
              // print(data[0]['text']);
            });
          }
        }
      ...
      case IntentType.links:
        {
          if (mounted) {
            setState(() {
              _isLinks = true;
              _links = data[0]['quick_replies'][0]['data'];
              // print(data[0]['text']);
            });
          }
        }
                          ...
                          ? Column(
                              children: <Widget>[
                                                          ...
                                                          return AnimationConfiguration
                                                            ...
                                                            child:
                                                              ...
                                                              child:
                                                                ...
                                                                child: InkWell(
                                                                    onTap: () =>
                                                                        _navigateToDetail(_vegaDiscussions[index]
                                                                            [
                                                                            'tid']),
                                                                    child:
                                                                        Padding(
                                ...
                                (_isLinks == true)
                                    ...
                                    : Center(),
                                (_isYoutubeVideo == true)
                                    ? (_dataReceived[0]['quick_replies'][0]
                                                ['data'] !=
                                            null)
                                        ? Column(
                                            children: [
