...
import 'package:karmayogi_mobile/ui/pages/_pages/careers/career_details_page.dart';
import 'package:karmayogi_mobile/util/helper.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class CareerItem extends StatelessWidget {
  const CareerItem({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => CareerDetailsPage()),
            ),
        // Navigator.push(
        //       context,
        //       FadeRoute(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            Helper.capitalize('Deputy Director'),
                            maxLines: 1,
                            style: GoogleFonts.lato(
                        ...
                        Container(
                          ...
                          child: Text(
                            Helper.capitalize('(Implementation)'),
                            maxLines: 1,
                            style: GoogleFonts.lato(
                              color: AppColors.greys87,
                              fontSize: 16,
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                            ...
                            child: Text(
                              AppLocalizations.of(context).mStaticShowInterest,
                              style: GoogleFonts.lato(
