...
class PrimaryEmailField extends StatefulWidget {
  ...
  @override
  State<PrimaryEmailField> createState() => _PrimaryEmailFieldState();
}

class _PrimaryEmailFieldState extends State<PrimaryEmailField> {
  ...
  _sendOTPToVerifyNumber() async {
    ...
    if (response['params']['errmsg'] == null ||
      ...
      Helper.showSnackBarMessage(
          context:
              EditMandatoryDetails.mandatoryDetailsGlobalKey.currentContext,
          text: AppLocalizations.of(context).mStaticOtpSentToMobile,
            ...
            children: [
              FieldNameWidget(
                  fieldName: widget.isEmailField
                      ? AppLocalizations.of(context).mStaticPrimaryEmail
                      : AppLocalizations.of(context).mStaticMobileNumber,
                  isMandatory: true),
              _freezeMobileField
                  ? Padding(
