    ...
    if (sortBy == EnglishLang.sortByName) {
      setState(() {
        _data.sort((a, b) => a['personalDetails']['firstname']
            ...
            .toLowerCase()
            .trim()
            .compareTo(b['personalDetails']['firstname']
                .toString()
                .toLowerCase()
                .trim()));
      });
  ...
  _filterNetworks() async {
    setState(() {
      _data = widget.peopleYouMayKnow.where((network) =>
          (((network['personalDetails']['firstname'] != null
                      ? network['personalDetails']['firstname']
                      : '') +
                  (network['personalDetails']['surname'] != null
    ...
    try {
      ...
      if (_response['result']['status'] == 'CREATED') {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context).mStaticConnectionRequestSent),
            ...
            children: [
              for (var item in _data)
                AnimationConfiguration.staggeredList(
                    position: _data.toList().indexOf(item),
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              ...
                              FadeRoute(
                                page:
                                    ChangeNotifierProvider<NetworkRespository>(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                                ...
                                                : item['profileDetails'] != null
                                                    ? (Text(
                                                        (item['profileDetails'][
                                                                    'personalDetails'] !=
                                                                null
                                                            ? (Helper.getInitials((item['profileDetails']['personalDetails']['firstname'] !=
                                                                            null
                                                    ...
                                                    : (Text(
                                                        item['personalDetails'] !=
                                                                null
                                                            ? Helper.getInitials((item['personalDetails']['firstname'] !=
                                                                            null
                                                                        ? item['personalDetails']
                                                                            [
                                                                            'firstname']
                                          ...
                                          children: [
                                            Wrap(
                                              children: [
                                                Text(
                                                  item['profileDetails'] != null
                                                      ? (item['profileDetails']['personalDetails'] != null
                                                          ? ((item['profileDetails']['personalDetails']['firstname'] != null
                                                                  ? item['profileDetails']['personalDetails'][
                                                                      'firstname']
                                                                  : '') +
                                                              ' ' +
                                                              (item['profileDetails']['personalDetails']['surname'] != null
                                                                  ? item['profileDetails']
                                                                          ['personalDetails'][
                                                                      'surname']
                                                                  : ''))
                                                      ...
                                                      : (item['personalDetails'] != null
                                                              ? (item['personalDetails']['firstname'] != null
                                                                      ? item['personalDetails']
                                                                          ['firstname']
                                                                      : '') +
                                                                  ' ' +
                                                                  (item['personalDetails']['surname'] != null ? item['personalDetails']['surname'] : '')
                                                              : 'Unknown user')
                                                          .toString()
                                                          .trim(),
                                                  style: GoogleFonts.lato(
                                ...
                                TextButton(
                                  onPressed: () {
                                    if (!_requestedConnections.any((element) =>
                                        element['id'] == item['id'])) {
