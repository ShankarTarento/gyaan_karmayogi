                      ...
                      child: widget.networkFromSearch != null
                                  ...
                                  child: Center(
                                    child: Text(
                                      (widget.networkFromSearch['profileDetails']
                                                  ['personalDetails'] !=
                                              null)
                                          ? Helper.getInitials((widget.networkFromSearch['profileDetails']
                                                                  ['personalDetails']
                                                              ['firstname'] !=
                                                          null
                                                      ? widget.networkFromSearch['profileDetails']
                                                  ...
                                                  .trim() +
                                              ' ' +
                                              (widget.networkFromSearch['profileDetails']['personalDetails']['surname'] != null
                                                      ? widget.networkFromSearch['profileDetails']
                                                              ['personalDetails']
                                                          ['surname']
                                                      : '')
                          ...
                          : (widget.suggestion.photo != ''
                              ...
                              : Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      Helper.getInitials((widget.suggestion
                                                          .firstName !=
                                                      null
                    ...
                    children: [
                          ...
                          (widget.networkFromSearch != null)
                              ? ((widget.networkFromSearch['profileDetails'] != null &&
                                      (widget.networkFromSearch['profileDetails']
                                              ['personalDetails'] !=
                                          null))
                                  ? (Helper.capitalize(widget.networkFromSearch['profileDetails']['personalDetails']['firstname'] != null ? widget.networkFromSearch['profileDetails']['personalDetails']['firstname'] : '') +
                                          ' ' +
                                          Helper.capitalize(widget.networkFromSearch['profileDetails']
                                                          ['personalDetails']
                                                      ['surname'] !=
                                                  null
                                              ? widget.networkFromSearch['profileDetails']
                                      ...
                                      .trim()
                                  : 'Unknown user')
                              : (Helper.capitalize(widget.suggestion.firstName != null ? widget.suggestion.firstName : '') +
                                      ' ' +
                      ...
                      (widget.networkFromSearch != null &&
                              ...
                              (widget.suggestion != null &&
                                  (widget.suggestion.verifiedKarmayogi == true))
                          ? Padding(
                    ...
                    child: Text(
                      (!widget.requestedConnections.any((element) =>
                              ...
                              (widget.suggestion != null
                                  ? widget.suggestion.id.toString()
                                  : widget.networkFromSearch['id'])))
                          ? AppLocalizations.of(context).mStaticConnect
