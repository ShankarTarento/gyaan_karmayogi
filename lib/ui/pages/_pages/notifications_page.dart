                          ...
                          ? TextButton(
                              ...
                              child: Text(
                                AppLocalizations.of(context)
                                    .mStaticShowUnreadNotifications,
                                    ...
                                    _notifications[index].seen
                                        ? ScaffoldMessenger.of(context)
                                            ...
                                            content: Text(AppLocalizations.of(
                                                    context)
                                                .mStaticNotificationMarkedAsRead),
                                            backgroundColor:
            ...
            child: _showAll
                ? Padding(
                    ...
                    child: TextButton(
                      ...
                      // minWidth: 175,
                      child: Text(
                        AppLocalizations.of(context).mStaticMarkAllAsRead,
                        style: GoogleFonts.lato(
                          color: AppColors.greys87,
                          fontWeight: FontWeight.w700,
                          fontSize: 14,
