...
class _CourseNavigationPageState extends State<CourseNavigationPage> {
  ...
  Future<void> _readContentProgress() async {
    ...
    if (widget.course['children'] != null) {
      for (index = 0; index < widget.course['children'].length; index++) {
        if ((widget.course['children'][index]['contentType'] == 'Collection' ||
          ...
          if (widget.course['children'][index]['children'] != null) {
            for (int i = 0;
              ...
              if (isCuratedProgram) {
                Course enrolledCourse = widget.enrollmentList.firstWhere(
                  (course) =>
                      course.raw['courseId'] ==
              ...
              navigationItems.add({
                ...
                'artifactUrl': widget.course['children'][index]['children'][i]
                    ['artifactUrl'],
                'streamingUrl': widget.course['children'][index]['children'][i]
                    ['streamingUrl'],
                'initFile': widget.course['children'][index]['children'][i]
                    ['initFile'],
                'primaryCategory': widget.course['children'][index]['children']
                    [i]['primaryCategory'],
                'currentProgress': '0',
                'status': 0,
        ...
        // Added below condition to handle course content items
            ...
            if (widget.course['children'][index]['children'][i]
              ...
              for (var j = 0;
                ...
                navigationItems.add({
                  ...
                  'streamingUrl': widget.course['children'][index]['children']
                      [i]['children'][j]['streamingUrl'],
                  'initFile': widget.course['children'][index]['children'][i]
                      ['children'][j]['initFile'],
                  'primaryCategory': widget.course['children'][index]
          ...
          if (isCuratedProgram) {
            Course enrolledCourse = widget.enrollmentList.firstWhere(
              (course) => course.raw['courseId'] == widget.course['identifier'],
              orElse: () => null,
            );
            parentBatchId = enrolledCourse != null
                ? enrolledCourse.raw['batch']['batchId']
          ...
          navigationItems.add({
            ...
            'streamingUrl': widget.course['children'][index]['streamingUrl'],
            'initFile': widget.course['children'][index]['initFile'],
            'primaryCategory': widget.course['children'][index]
                ['primaryCategory'],
            'currentProgress': '0',
            'status': 0,
  ...
  Future<dynamic> _showFinishPopup() async {
    ...
    await showDialog(
        ...
        builder: (context) => AlertDialog(
              title: Text(
                "${AppLocalizations.of(context).mCourseCongratsForCompletingThe} ${widget.course['name']}",
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)
                          .mcourseNavigationCourseCompletedMsg,
                      style: GoogleFonts.lato(
                        color: AppColors.greys87,
                      ),
                    ),
                        ...
                        children: [
                          TextSpan(
                            ...
                            text: AppLocalizations.of(context)
                                .mCourseNavigationPleaseTakemomentTo,
                          ),
                          TextSpan(
                            style: GoogleFonts.lato(
                          ...
                          TextSpan(
                            style: GoogleFonts.lato(
                                ...
                                fontSize: 16),
                            text: AppLocalizations.of(context)
                                .mCourseAndTellUsAboutYourExperience,
                          ),
                        ],
                      ),
                    ),
            ...
            )).whenComplete(() => InAppReviewRespository().triggerInAppReviewPopup());
    return true;
    // if (_courseIndex ==
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context).mcourseRegisterOrSignin,
              ...
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context).mRegisterregister,
                      style: GoogleFonts.lato(
                          height: 1.429,
                          letterSpacing: 0.5,
                          fontSize: 14,
                ...
                Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context).mCourseOr,
                    style: GoogleFonts.lato(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                        color: AppColors.primaryThree),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context).mCommonSignIn,
                      style: GoogleFonts.lato(
                          height: 1.429,
                          letterSpacing: 0.5,
                          fontSize: 14,
      ...
      child: InkWell(
        onTap: () {
          _generateInteractTelemetryData(
              content['identifier'], content['primaryCategory']);
            ...
            Navigator.push(
                ...
                FadeRoute(
                    page: CourseAssessmentPlayer(
                        ...
                        isCuratedProgram
                            ? content['parentBatchId']
                            : widget.batchId,
                        content['duration'],
                        primaryCategory: content['primaryCategory'],
                        parentCourseId: isCuratedProgram
                            ? content['parentCourseId']
                            : widget.course['identifier'])));
            setState(() {
                  ...
                  FadeRoute(
                      page: ContentFeedback(
                          ...
                          isCuratedProgram
                              ? content['parentBatchId']
                              : widget.batchId,
                          updateContentProgress: _showLatestProgress,
                          parentCourseId: isCuratedProgram
                              ? content['parentCourseId']
                              : widget.course['identifier'])));
            }
  ...
  _openInNewScreen(Widget player, {bool isYoutubeContent = false}) {
    return Center(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text(AppLocalizations.of(context).mCoursePressPlayBtn),
        SizedBox(
          height: 16,
        ),
        IconButton(
  ...
  _openCourseHtmlScreen(Widget player, {bool isYoutubeContent = false}) {
    return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
                  ...
                  child: (navigationItems[_courseIndex]['mimeType'] ==
                      ...
                      ? CourseVideoPlayer(
                          ...
                          batchId: isCuratedProgram
                              ? navigationItems[_courseIndex]['parentBatchId']
                              : widget.batchId,
                          parentCourseId: isCuratedProgram
                              ? navigationItems[_courseIndex]['parentCourseId']
                              : widget.course['identifier'],
                          parentAction: _showLatestProgress,
                          isFeatured: widget.isFeatured,
                          primaryCategory: navigationItems[_courseIndex]
                              ['primaryCategory'],
                        )
                      : navigationItems[_courseIndex]['mimeType'] ==
                              EMimeTypes.mp3
                          ...
                          : navigationItems[_courseIndex]['mimeType'] ==
                              ...
                              ? CoursePdfPlayer(
                                  ...
                                  isFeaturedCourse: widget.isFeatured,
                                  updateProgress: _showLatestProgress,
                                  primaryCategory: navigationItems[_courseIndex]
                                      ['primaryCategory'],
                                )
                              : navigationItems[_courseIndex]['mimeType'] ==
                                      EMimeTypes.html
                                  ? _openCourseHtmlScreen(
                                      CourseHtmlPlayer(
                                          widget.course,
                                          navigationItems[_courseIndex]
                                              ['identifier'],
                                      ...
                                      : navigationItems[_courseIndex]
                                          ...
                                          ? (!widget.isFeatured
                                              ? Center(
                                                  ...
                                                  navigationItems[_courseIndex]
                                                              ['status'] ==
                                                          2
                                                      ? AppLocalizations.of(context).mStaticSurveyAlreadySubmitted
                                                      : AppLocalizations.of(context).mCourseTapOnSurveyToSTart,
                                                  textAlign: TextAlign.center,
                                                  style: GoogleFonts.lato(
                                                      height: 1.5,
                                                      color: AppColors.greys87,
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          AppLocalizations.of(
                                                                  context)
                                                              .mStaticDoSignInOrRegisterMessage,
                                                          textAlign:
                                                              TextAlign.center,
                                                          style:
                                                              GoogleFonts.lato(
                                          ...
                                          : (!widget.isFeatured
                                              ? Padding(
                                                  ...
                                                  child: Center(
                                                      child: Text(
                                                    AppLocalizations.of(context).mCourseTapOnAssessment,
                                                    textAlign: TextAlign.center,
                                                    style: GoogleFonts.lato(
                                                        height: 1.5,
                                                        color:
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        decoration: BoxDecoration(
                                                            ...
                                                            color:
                                                                Colors.white),
                                                        child: widgetNavigation[i][k][0]['moduleName'] != null ?
                                                        ExpansionTile(
                                                            onExpansionChanged:
                                                                (value) {},
                                                            // initiallyExpanded:
                                                                ...
                                                                ? Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      !widget.isFeatured &&
                                                                              !isCuratedProgram
                                                                          ? Padding(
                                                                              padding: const EdgeInsets.only(top: 5, left: 8, right: 0),
                                                                              child: Container(
                                                                                height: 20,
                                                                                width: 20,
                                                                                child: CircularProgressIndicator(
                                                                                    ...
                                                                                    valueColor: AlwaysStoppedAnimation<Color>(
                                                                                      _getModuleProgress(widgetNavigation[i][k]) < 1 ? AppColors.primaryOne : AppColors.positiveLight,
                                                                                    ),
                                                                                    strokeWidth: 3,
                                                                    ...
                                                                    onTap: () {
                                                                      _generateInteractTelemetryData(
                                                                          ...
                                                                          widgetNavigation[i][k][j]
                                                                              [
                                                                              'primaryCategory']);
                                                                      if ((widgetNavigation[i][k][j]['mimeType'] == EMimeTypes.assessment || widgetNavigation[i][k][j]['mimeType'] == EMimeTypes.newAssessment) &&
                                                                          !widget
                                                                              .isFeatured) {
                                                                        Navigator.push(
                                                                            context,
                                                                            FadeRoute(page: CourseAssessmentPlayer(widget.course, widgetNavigation[i][k][j]['name'], widgetNavigation[i][k][j]['identifier'], widgetNavigation[i][k][j]['artifactUrl'], updateContentProgress, isCuratedProgram ? widgetNavigation[i][k][j]['parentBatchId'] : widget.batchId, widgetNavigation[i][k][j]['duration'], primaryCategory: widgetNavigation[i][k][j]['primaryCategory'], parentCourseId: isCuratedProgram ? widgetNavigation[i][k][j]['parentCourseId'] : widget.course['identifier'])));
                                                                        setState(
                                                                            () {
                                                                          _courseIndex =
                                                                        ...
                                                                        if (widgetNavigation[i][k][j]['status'] !=
                                                                          ...
                                                                          Navigator.push(
                                                                              context,
                                                                              FadeRoute(page: ContentFeedback(widgetNavigation[i][k][j]['artifactUrl'], widgetNavigation[i][k][j]['name'], widget.course, widgetNavigation[i][k][j]['identifier'], isCuratedProgram ? widgetNavigation[i][k][j]['parentBatchId'] : widget.batchId, updateContentProgress: _showLatestProgress, parentCourseId: isCuratedProgram ? widgetNavigation[i][k][j]['parentCourseId'] : widget.course['identifier'])));
                                                                        }
                                                                        setState(
                                                                            () {
                                                                          _courseIndex =
                                                            ...
                                                            child:
                                                                CircularProgressIndicator(
                                                                    ...
                                                                    valueColor:
                                                                        AlwaysStoppedAnimation<
                                                                            Color>(
                                                                      _getModuleProgress(widgetNavigation[i]) < 1
                                                                          ? AppColors
                                                                              .primaryOne
                                                                          : AppColors
                                                                              .positiveLight,
                                                                ...
                                                                FadeRoute(
                                                                    page: ContentFeedback(
                                                                        ...
                                                                        updateContentProgress:
                                                                            _showLatestProgress,
                                                                        parentCourseId: isCuratedProgram
                                                                            ? widgetNavigation[i][j]['parentCourseId']
                                                                            : widget.course['identifier'])));
                                                          }
                                                          setState(() {
                                                            _courseIndex =
                                                            ...
                                                            : Container(
                                                                padding:
                                                                    EdgeInsets
                                                                        .all(8),
                                                                child: Text(
                                                                    AppLocalizations.of(context).mCourseNoContentsAvailable)),
                                                      )),
                                              ]),
                                        ),
                                      )
