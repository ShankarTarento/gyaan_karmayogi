  ...
  void _generateTelemetryData() async {
    ...
    Map eventData1 = Telemetry.getImpressionTelemetryEvent(
        ...
        TelemetryPageIdentifier.topicCoursesPageUri
            .replaceAll(":topic", widget.name.toString()),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          // ]),
          title: Text(
            AppLocalizations.of(context).mTopicBackToAllTopics,
            style: GoogleFonts.lato(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    '${AppLocalizations.of(context).mTopicTop} $_name ${AppLocalizations.of(context).mTopicPicksForYou}',
                                    style: GoogleFonts.lato(
                                      color: AppColors.greys87,
                                      fontWeight: FontWeight.w700,
                                      fontSize: 16,
                                      ...
                                      Container(
                                        width:
                                            MediaQuery.of(context).size.width -
                                                25,
                                        child: Text(
                                          '${AppLocalizations.of(context).mTopicExploreUnder} $_name',
                                          style: GoogleFonts.lato(
                                            color: AppColors.greys87,
                                            fontWeight: FontWeight.w700,
                                            fontSize: 16,
