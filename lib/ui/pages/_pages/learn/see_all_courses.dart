      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isRecommended
              ? AppLocalizations.of(context).mStaticAllRecommendedCBPs
              : AppLocalizations.of(context).mStaticBasedOnYourInterests,
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: BrowseCard(
                    ...
                    isBlendedProgram:
                        widget.courses[index].raw["primaryCategory"] ==
                                    'Blended Program' ||
                                widget.courses[index].raw["content"]
                                        ["primaryCategory"] ==
                                    'Blended Program'
                            ? true
                            : false,
