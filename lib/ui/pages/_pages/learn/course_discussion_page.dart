...
class _CourseDiscussionPageState extends State<CourseDiscussionPage> {
  ...
  void didChangeDependencies() {
    _dropdownValue = AppLocalizations.of(context).mStaticRecent;
    dropdownItems = [
      LocalizationText(
          displayText: AppLocalizations.of(context).mStaticRecent,
          value: EnglishLang.recent),
      LocalizationText(
          displayText: AppLocalizations.of(context).mStaticPopular,
                  ...
                  : Container(
                      ...
                      child: Center(
                        ...
                        Padding(
                            ...
                            child: Text(
                              AppLocalizations.of(context).mStaticNoDiscussions,
                              style: GoogleFonts.lato(
