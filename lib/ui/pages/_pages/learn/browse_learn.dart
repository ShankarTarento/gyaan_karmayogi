      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            // ),
            Container(
              margin: EdgeInsets.only(left: 16.0, right: 16.0, top: 24),
              // padding: const EdgeInsets.fromLTRB(0, 20, 0 , 10),
              child: AnimationLimiter(
                child: Column(
                  children: BROWSEBY(context: context)
                      .map(
                        (browseBy) => AnimationConfiguration.staggeredList(
                          position:
                              BROWSEBY(context: context).indexOf(browseBy),
