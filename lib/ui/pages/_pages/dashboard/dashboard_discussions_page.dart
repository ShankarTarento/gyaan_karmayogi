        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Visualization(
                heading:
                    AppLocalizations.of(context).mDashboardYourProfileViewed,
                subHeading:
                    AppLocalizations.of(context).mDashboardUniqueVisitorNumber,
                legend: AppLocalizations.of(context).mDashboardProfileViews,
            ...
            Container(
              ...
              color: Colors.white,
              child: Visualization(
                heading: AppLocalizations.of(context).mDashboardPlatformUsage,
                subHeading: AppLocalizations.of(context).mDashboardUsageDays,
                legend: AppLocalizations.of(context).mDashboardUsageHours,
