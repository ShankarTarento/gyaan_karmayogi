...
class _KnowledgeResourceDetailsState extends State<KnowledgeResourceDetails>
  ...
  Future<dynamic> downloadFile(String fileType, String url, index,
    ...
    if (url == '') {
      _displayDialog(false, '', parentContext: parentContext);
      return;
    }
    ...
    response.asStream().listen((http.StreamedResponse r) {
      ...
      r.stream.listen((List<int> chunk) {
        ...
        //   _progress[index] = 1;
        // });
        _displayDialog(true, filePath, parentContext: parentContext);
        return;
      });
    });
  }
                    ...
                    (widget.knowledgeResource.raw['additionalProperties'] !=
                        ...
                        ? (Padding(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  AppLocalizations.of(context).mStaticRecent,
                                  style: GoogleFonts.lato(
                                      color: AppColors.greys87,
                                      fontSize: 14.0,
                                      fontWeight: FontWeight.w400),
