...
class _NetworkProfileDetailState extends State<NetworkProfileDetail> {
  ...
  void initState() {
    ...
    if (_start == 0) {
      ...
      pageUri = TelemetryPageIdentifier.userProfilePageId
  ...
  void _generateTelemetryData() async {
    ...
    Map eventData1 = Telemetry.getImpressionTelemetryEvent(
        ...
        objectId: widget.profileId,
        objectType: TelemetrySubType.userCard);
    telemetryEventData =
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: SectionHeading(
                  AppLocalizations.of(context).mNetworkProfileCareerHistory),
            ),
            ...
            Container(
              alignment: Alignment.topLeft,
              child: SectionHeading(
                  AppLocalizations.of(context).mNetworkProfileAcademics),
            ),
            ...
            Container(
              alignment: Alignment.topLeft,
              child: SectionHeading(
                  AppLocalizations.of(context).mNetworkProfileSimilarProfiles),
            ),
            Container(
              height: 282,
