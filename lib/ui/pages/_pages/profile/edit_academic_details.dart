      ...
      if (response['params']['errmsg'] == null ||
        ...
        snackBar = SnackBar(
          content: Container(
              ...
              child: Text(
            AppLocalizations.of(context).mStaticAcademicDetailsUpdatedText,
          )),
      ...
      children: [
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _fieldNameWidget(AppLocalizations.of(context).mProfileDegree),
              InkWell(
              ...
              _fieldNameWidget(
                  AppLocalizations.of(context).mProfileYearOfPassing),
              Padding(
              ...
              return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ),
                      _titleFieldWidget(
                          AppLocalizations.of(context).mProfileTenth),
                      Container(
                        width: double.infinity,
                        color: Colors.white,
                        // margin: EdgeInsets.only(top: 5.0),
                      ...
                      _titleFieldWidget(
                          AppLocalizations.of(context).mProfileTwelveth),
                      Container(
                        width: double.infinity,
                        color: Colors.white,
                        // margin: EdgeInsets.only(top: 5.0),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextButton(
                                  ...
                                  child: Text(
                                    AppLocalizations.of(context)
                                        .mProfileAddAnotherQualification,
                                    style: GoogleFonts.lato(
                                      color: AppColors.primaryThree,
                                      fontWeight: FontWeight.w700,
                                      fontSize: 14,
                      ...
                      _titleFieldWidget(
                          AppLocalizations.of(context).mStaticPostGradDetails),
                      Container(
                        color: Colors.white,
                        child: Column(
                          children: [
