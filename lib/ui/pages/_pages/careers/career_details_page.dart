...
import 'package:karmayogi_mobile/ui/pages/_pages/careers/position_info_page.dart';
import 'package:karmayogi_mobile/ui/widgets/_career/career_details_tab.dart';
...
class CareerDetailsPage extends StatefulWidget {
  final tabIndex;
  const CareerDetailsPage({Key key, this.tabIndex = 0}) : super(key: key);
  static const route = AppUrl.careersHub;

  @override
  _CareerDetailsPageState createState() => _CareerDetailsPageState();
}
...
class _CareerDetailsPageState extends State<CareerDetailsPage>
  ...
  void initState() {
    ...
    _controller = TabController(
        length: CareerDetailsTab.items.length, vsync: this, initialIndex: 0);
                    ...
                    title: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            AppLocalizations.of(context).mStaticCareers,
                ...
                SliverPersistentHeader(
                  delegate: SilverAppBarDelegate(
                    TabBar(
                        ...
                        tabs: [
                          for (var tabItem in CareerDetailsTab.items)
                            Container(
                              // width: 125.0,
                              padding:
