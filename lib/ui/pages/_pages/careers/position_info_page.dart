                ...
                child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(top: 12, bottom: 12),
                        child: Text(
                          AppLocalizations.of(context).mStaticCompetencyGaps,
                          style: GoogleFonts.lato(
                              decoration: TextDecoration.none,
                              color: AppColors.greys87,
                              fontSize: 14,
                ...
                child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(top: 12, bottom: 12),
                        child: Text(
                          AppLocalizations.of(context).mStaticPeople,
                          style: GoogleFonts.lato(
                              decoration: TextDecoration.none,
                              color: AppColors.greys87,
                              fontSize: 14,
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    AppLocalizations.of(context).mStaticFollow,
                    style: TextStyle(
                        fontSize: 14,
                        color: AppColors.primaryThree,
                        fontWeight: FontWeight.w700),
