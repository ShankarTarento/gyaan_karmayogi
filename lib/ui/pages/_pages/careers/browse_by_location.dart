...
class BrowseByLocation extends StatefulWidget {
  const BrowseByLocation({Key key}) : super(key: key);

  @override
  _BrowseByLocationState createState() => _BrowseByLocationState();
}

class _BrowseByLocationState extends State<BrowseByLocation> {
                      ...
                      child: Padding(
                        ...
                        child: Text(
                            AppLocalizations.of(context)
                                .mStaticBrowseCareersByLocation,
