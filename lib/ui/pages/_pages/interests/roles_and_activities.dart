...
class _RolesAndActivitiesState extends State<RolesAndActivities> {
  ...
  Future<void> _populateFields() async {
    if (_profileDetails != null && mounted) {
      setState(() {
      ...
      child: Column(
        ...
        children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context).mRolesPleaseListRoles +
                          ((_designation != null &&
                                  (_designation != '' &&
                                      _designation != 'null'))
                              ? _designation
          ...
          Container(
            child: Row(
              ...
              children: [
                RichText(
                  text: TextSpan(
                      text: AppLocalizations.of(context).mRolesAddRole,
                      style: GoogleFonts.lato(
                          color: AppColors.greys87,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 8),
                      child: Text(AppLocalizations.of(context).mRolesWhatIsRole,
                          style: GoogleFonts.lato(
                              color: AppColors.greys87,
                              fontWeight: FontWeight.w600,
                              height: 1.5,
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if ((value.isEmpty || value.trim().length == 0) &&
                      ...
                      return AppLocalizations.of(context).mRoleIsMandatory;
                    } else if ((_rolesAndActivities
                            .any((element) => element['name'] == value) &&
                        !_isEditing)) {
                      return AppLocalizations.of(context).mRoleAlreadyExist;
                    } else {
                      return null;
                    }
                  },
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: AppLocalizations.of(context).mRolesTypeRoleName,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                RichText(
                  text: TextSpan(
                      text: AppLocalizations.of(context).mRolesAddActivities,
                      style: GoogleFonts.lato(
                          color: AppColors.greys87,
                          fontWeight: FontWeight.w600,
                          height: 1.5,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 8),
                      child: Text(AppLocalizations.of(context).mRolesWhatIsActivity,
                          style: GoogleFonts.lato(
                              color: AppColors.greys87,
                              fontWeight: FontWeight.w600,
                              height: 1.5,
                    ...
                    child: TextFormField(
                      ...
                      validator: (String activity) {
                        if (_activities.any((element) =>
                          ...
                          return AppLocalizations.of(context).mRolesActivityAlreadyExist;
                        } else if (activity.toString().trim().length == 1) {
                          return AppLocalizations.of(context).mRolesPleaseAddValidActivityName;
                            ...
                            (_isEditing
                                ? true
                                : _rolesAndActivities.length == 0)) {
                          return AppLocalizations.of(context).mRolesActivityIsMandatory;
                        }
                        return null;
                      },
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            borderSide: BorderSide(color: AppColors.grey16)),
                        hintText: AppLocalizations.of(context).mRolesTypeActivity,
                        helperText: AppLocalizations.of(context).mRoleStartAddingActivities,
                        isDense: false,
                        isCollapsed: false,
                    ...
                    onPressed: ((_roleController.text.trim().length > 0 &&
                        ...
                        ? () async {
                            if (_roleController.text.trim().length != 0 &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(AppLocalizations.of(context).mRolesPleaseAddRole),
                                  backgroundColor: AppColors.negativeLight,
                                ),
                              );
                            }
              ...
              : Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (_roleController.text.trim().length > 0 &&
                        ...
                        : () {},
                    child: Text(
                      AppLocalizations.of(context).mStaticUpdate,
                      style: TextStyle(
                          fontSize: 14,
                          color: (_roleController.text.trim().length > 0 &&
                                  _activities.length > 0)
          ...
          Container(
            alignment: Alignment.center,
            child: Text(
              AppLocalizations.of(context).mRolesSelectionsAutomaticallySaved,
              style: GoogleFonts.lato(
                  color: AppColors.greys87,
                  fontSize: 12,
                  letterSpacing: 0.25,
