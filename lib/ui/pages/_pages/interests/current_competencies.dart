...
class _CurrentCompetenciesState extends State<CurrentCompetencies> {
  ...
  Future<void> _populateFields() async {
    if (mounted && _profileDetails != null) {
      setState(() {
  ...
  Future<List<BrowseCompetencyCardModel>> _getListOfCompetencies() async {
    if (!_pageInitilized && mounted) {
      ...
      if (widget.isDesiredCompetencies) {
        ...
        // List attestedCompetencies = [];
        _profileDetails[0].competencies.forEach((competency) {
          if (competency['competencyCBPCompletionLevel'] != null) {
            // attestedCompetencies.add(element);
            if (_listOfCompetencies
                .any((element) => element.id != competency['id'])) {
              _listOfCompetencies
                  .removeWhere((element) => element.id == competency['id']);
    ...
    for (var selectedCompetency in _selectedCompetencies) {
      if (selectedCompetency['id'] == competency.id) {
        if (selectedCompetency['competencySelfAttestedLevel']
          ...
          selectedLevelValue = selectedCompetency['competencySelfAttestedLevel']
                      .runtimeType ==
                  String
              ? (selectedCompetency['competencySelfAttestedLevel'].length == 1
                  ? int.parse(selectedCompetency['competencySelfAttestedLevel'])
                  : ((selectedCompetency['competencySelfAttestedLevelValue']
                                  .split(' ')
                                  .length ==
                              2 &&
                          selectedCompetency['competencySelfAttestedLevelValue']
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      hint: Container(
                          ...
                          child:
                              Text(AppLocalizations.of(context).mCommonSortBy)),
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                        AppLocalizations.of(context).mStaticWhatAreCompetencies,
                        style: GoogleFonts.lato(
                            color: AppColors.greys87,
                          ...
                          children: [
                            AnimationLimiter(
                              child: ListView.builder(
                                ...
                                itemCount: _showMore
                                    ? _filteredListOfCompetencies.length
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    width: MediaQuery.of(context)
                                                                        ...
                                                                        0.3,
                                                                    child: Text(
                                                                      _filteredListOfCompetencies[index].name !=
                                                                              null
                                                                  ...
                                                                  Padding(
                                                                    padding: const EdgeInsets
                                                                        ...
                                                                        top: 4),
                                                                    child: Text(
                                                                      _filteredListOfCompetencies[index].competencyType !=
                                                                              null
                                                                          ? _filteredListOfCompetencies[index]
                                                                              .competencyType
                                                                          : '',
                                                          ...
                                                          onPressed: () =>
                                                              showDialog(
                                                                  ...
                                                                  builder: (ctx) =>
                                                                      LevelInfo(
                                                                        levelDetails:
                                                                            _filteredListOfCompetencies[index].levels,
                                                                      )),
                                                          icon: Icon(Icons
                                                              .info_outline),
                                                          color:
