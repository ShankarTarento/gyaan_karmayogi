...
class _AllCompetenciesPageState extends State<AllCompetenciesPage> {
  ...
  Future<dynamic> getCompetencyFuture;
  ...
  _getFutureData() {
    getCompetencyFuture = _getListOfCompetencies();
  }
