...
class BrowseCompetencyCardModel {
  ...
  final String competencyCBPCompletionLevelValue;
  final String competencyCBPCompletionLevelName;
  ...
  BrowseCompetencyCardModel(
      ...
      this.competencyCBPCompletionLevelValue,
      this.competencyCBPCompletionLevelName,
    ...
    return BrowseCompetencyCardModel(
      ...
      selfAttestedLevel: json['competencySelfAttestedLevel'].runtimeType ==
          ...
          ? (json['competencySelfAttestedLevel'].length == 1
              ...
              : ((json['competencySelfAttestedLevelValue'].split(' ').length ==
                          2 &&
      ...
      competencyCBPCompletionLevel:
          json['competencyCBPCompletionLevel'].runtimeType == String
              ? json['competencyCBPCompletionLevel'].toString().isNotEmpty
                  ? int.parse(json['competencyCBPCompletionLevel'])
                  : 0
              : json['competencyCBPCompletionLevel'],
      competencyCBPCompletionLevelValue:
          json['competencyCBPCompletionLevelValue'],
      competencyCBPCompletionLevelName:
          json['competencyCBPCompletionLevelValue'],
