...
class HallOfFameAssets {
  static const IconData up = Icons.arrow_drop_up_sharp;
  static const IconData down = Icons.arrow_drop_down_sharp;
  static const String rankOneBg = 'assets/img/rank_one.png';
  static const String rankTwoBg = 'assets/img/rank_two.png';
  static const String rankThreeBg = 'assets/img/rank_three.png';
  static const String dots = 'assets/img/dots.png';
  static const String crown = 'assets/img/rank_one_crown.png';
  static const String kp_logo = 'assets/img/kp_icon.svg';
  static const String emblem_logo = 'assets/img/emblem.jpg';
  static const String clock = 'assets/img/clock_white.svg';
}
...
class RegistrationType {
  static const int resendOtpTimeLimit = 180;
  static const int resendEmailOtpTimeLimit = 180;
}
...
const SCENARIO_1_SUMMARY = const [
  ...
  InformationCardModel(
      scenarioNumber: 2,
      icon: Icons.replay,
      information: 'Unlimited retakes allowed',
      iconColor: AppColors.primaryThree),
  InformationCardModel(
      scenarioNumber: 3,
      icon: Icons.timer,
...
const PRACTICE_SCENARIO_1_SUMMARY = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.list,
      information: '3 questions',
...
const SCENARIO_1_INFO = const [
  ...
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.info,
      information: 'Skipped questions can be attempted again before submitting',
      iconColor: AppColors.greys60)
];

const PRACTICE_SCENARIO_1_INFO = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.info,
      information: 'No negative mark',
...
const SCENARIO_4_SUMMARY = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.list,
      information: '3 questions',
...
const PRACTICE_SCENARIO_4_SUMMARY = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.list,
      information: '3 questions',
...
const PRACTICE_SCENARIO_4_INFO = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.info,
      information: 'Unlimited Retakes are allowed',
      iconColor: AppColors.primaryThree),
  InformationCardModel(
      scenarioNumber: 2,
      icon: Icons.info,
  ...
  InformationCardModel(
      scenarioNumber: 3,
      icon: Icons.info,
      information: 'No negative marking',
      iconColor: AppColors.greys60),
];

const SCENARIO_4_INFO = const [
  InformationCardModel(
      scenarioNumber: 1,
      icon: Icons.info,
      information: 'Unlimited Retakes are allowed',
  ...
  InformationCardModel(
      scenarioNumber: 2,
      icon: Icons.info,
      information: 'If the given time runs out, the answer will be auto-submitted',
      iconColor: AppColors.greys60),
  InformationCardModel(
      scenarioNumber: 3,
      icon: Icons.info,
